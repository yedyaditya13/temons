                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'code_member'">{{ trans('admin.member.columns.code_member') }}</th>
                                        ...
                                        <th is='sortable' :column="'checkin'">{{ trans('admin.member.columns.checkin') }}</th>
                                        <th is='sortable' :column="'checkout'">{{ trans('admin.member.columns.checkout') }}</th>
                                        <th is='sortable' :column="'member_status'">{{ trans('admin.member.columns.member_status') }}</th>
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                        ...
                                        <td>@{{ item.address }}</td>
                                        <td>@{{ item.phone }}</td>
                                        <td>@{{ item.checkin | date('dddd, D MMMM Y') }}</td>
                                        <td>@{{ item.checkout | date('dddd, D MMMM Y') }}</td>
                                        <td>
                                            <label class="switch switch-3d switch-danger">
                                                
                                                <input type="checkbox" class="switch-input" v-model="collection[index].member_status" @change="toggleSwitch(item.resource_url, 'member_status', collection[index])">
